...
| [`cloudinit/qwen-3.8-flash-next/`](cloudinit/qwen-3.8-flash-next/) | `llama.cpp` OpenAI-compatible LLM server — [Qwen3.8-Flash-Next Uncensored](https://huggingface.co/orcarouter/Qwen3.8-Flash-Next-Uncensored-GGUF) GGUF (**Q5_K_M**, ~125 GiB MoE). No Q6. | **2× 80 GB** (see folder README) |
