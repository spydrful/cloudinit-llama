...
**2× 80 GB** for weights; **4× 80 GB** for YaRN **1M** context.
...
| [`cloudinit/qwen-3.8-flash-next/`](cloudinit/qwen-3.8-flash-next/) | `llama.cpp` OpenAI-compatible LLM server — [Qwen3.8-Flash-Next Uncensored](https://huggingface.co/orcarouter/Qwen3.8-Flash-Next-Uncensored-GGUF) GGUF (**Q5_K_M**, ~125 GiB MoE, YaRN **1M**). | **4× 80 GB** (2× for native 262k) |
